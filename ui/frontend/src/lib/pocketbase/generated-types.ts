...
export type SurveyIndicatorsResponse<Texpand = unknown> = Required<SurveyIndicatorsRecord> &
    BaseSystemFields<Texpand>;
export type SurveyParticipantsResponse<Texpand = unknown> = Required<SurveyParticipantsRecord> &
    BaseSystemFields<Texpand>;
export type SurveyQuestionTypesResponse = Required<SurveyQuestionTypesRecord> & BaseSystemFields;
export type SurveyQuestionsResponse<Texpand = unknown> = Required<SurveyQuestionsRecord> &
    BaseSystemFields<Texpand>;
export type SurveyThemesResponse<Texpand = unknown> = Required<SurveyThemesRecord> &
    BaseSystemFields<Texpand>;
export type SurveysResponse<Texpand = unknown> = Required<SurveysRecord> &
    BaseSystemFields<Texpand>;
